dic = {"firstname": "titi","name": "toto","promo": 2022,"group": 202}
print(f"votre nom est '{dic['name']}', prénom est '{dic['firstname']}', "
      f""f"vous faites partie de la promo '{dic['promo']}' et votre groupe est '{dic['group']}'.")
...
perso1 = dic
perso2 = {"firstname": "tata","name": "tutu","promo": 2023,"group": 102}
binome = {"id1": perso1,"id2": perso2}
